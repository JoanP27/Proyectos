...
namespace Pomares_Joan_GestionTareas03._01
{
    public class ServiceUser : IDisposable
    {
        ...
        public Task<User?> Listar(int id)
        {
            ...
            using (var _context = new TaskManagerDbContext())
            {
                return _context.Users
                .AsNoTracking()
                .FirstOrDefaultAsync(u => u.Id == id); // Devuelve el primer objeto que cunpla la condicion de la expresión lambda
            }
        }
